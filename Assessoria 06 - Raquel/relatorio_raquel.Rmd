...
***
## Relatório de Consultoria da Alice  - Sensoriamento Remoto
### Introdução
...
As médias das variáveis Resposta são significativamente iguais sob o efeito dos níveis do tratamento com óleo essencial de oliva?

##Teste
A realização Teste de Hipótese proposto no modelo considete na Análise de Variância pela tabela ANOVA. Esse teste considera a razão entre o Quadrado Médio dos Tratamentos pelo Quadrado Médio do Erro Experimental uma estatítica de um parâmetro de distribuição $F_{t-1; t(r-1)}$, sendo $t$ total de tratamentos e $r$ o número de repetições. 
